...
export const OnlineUsersList: React.FC<OnlineUsersListProps> = ({ users, loading, error }) => {
  ...
  const getAddress = (user: OnlineUser): string | null => {
    ...
    <div className="online-users-list">
      {users.map((user) => (
        <div key={user.id} className="user-item">
          ...
          <div className="user-status online">オンライン</div>
        </div>
      ))}
    </div>
  );
